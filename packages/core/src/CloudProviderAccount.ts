...
export default abstract class CloudProviderAccount {
  id?: string
  name?: string
  async getRegionData(
  ...
  abstract accumulateKnownRowData(dataMapper: IMapper): void
  abstract getCostAndEstimateSingleRow(dataMapper: IMapper): IMapper
}
